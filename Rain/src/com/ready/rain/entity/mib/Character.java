...
public class Character extends Mob {
	...
	public Character (
			...
			int xjoint1,int yjoint1,
			int xjoint2,int yjoint2,
			int xjoint3,int yjoint3,
			int xjoint4,int yjoint4,
			int xjoint5,int yjoint5,
			int xjoint6,int yjoint6, 
			int xjoint7,int yjoint7,
			int xjoint8,int yjoint8,
			int xjoint9,int yjoint9) {
