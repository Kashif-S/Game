...
public class Game extends Canvas implements Runnable {
	...
	public Game () {
		...
		//character = new Character(x,y,image1,image2,image3,image4,image5,image6,image7,image8,image9,0,10,11,-16,44,10,11,-16,35,68,14,12,17,69,20,0,12,21,key);
		character = new Character (width*scale/2,height*scale/2,image1,image2,image3,image4,image5,image6,image7,image8,image9,0,10,11,-16,44,10,11,-16,35,68,14,12,17,69,20,0,12,21,key);
	}
...
if(MouseX > 325 && MouseX < 811 && MouseY	 > 218 && MouseY < 318 && data2 > 0 && click == 1&&select == 2){
	System.out.println("loading...");
	Game.level = new ReadLevel("/textures/WorldGen/world" + data2 + ".png" );
	loaded = true;
	LevelSelect = false;
	WorldS = false;
	menu = true;
...
if(MouseX > 325 && MouseX < 811 && MouseY	 > 361 && MouseY < 461 && data3 > 0 && click == 1&&select == 3){
	System.out.println("loading...");
	Game.level = new ReadLevel("/textures/WorldGen/world" + data3 + ".png" );
	loaded = true;
	LevelSelect = false;
	WorldS = false;
	menu = true;
...
if(MouseX > 325 && MouseX < 811 && MouseY	 > 504 && MouseY < 604 && data4 > 0 && click == 1&&select == 4){
	System.out.println("loading...");
	Game.level = new ReadLevel("/textures/WorldGen/world" + data4 + ".png" );
	loaded = true;
	LevelSelect = false;
	WorldS = false;
	menu = true;
