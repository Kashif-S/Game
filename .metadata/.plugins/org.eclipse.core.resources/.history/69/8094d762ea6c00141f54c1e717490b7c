...
public class Character {
	...
	public Character (int x, int y,BufferedImage righttorso,BufferedImage lefttorso,BufferedImage rightarm,BufferedImage leftarm,int xjoint1,int yjoint1,int xjoint2,int yjoint2,int xjoint3,int yjoint3,int xjoint4,int yjoint4) {
